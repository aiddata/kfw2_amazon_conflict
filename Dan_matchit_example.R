...
#load saved data
load("Interim Data/Land Violence Data.Rda")
load("Interim Data/Individual Violence Data.Rda")
load("Interim Data/Demarcation Date Data.Rda")
load("Interim Data/Land Violence Overlap.Rda")
load("Interim Data/Individual Violence Overlap.Rda")
